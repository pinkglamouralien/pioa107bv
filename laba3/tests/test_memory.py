...
class TestRestaurantDB(unittest.TestCase):
    ...
    def test_update_guest(self):
        ...
        self.assertEqual(
            self.db.guests[0].name,
            "Петр"
        )

        self.assertEqual(
            self.db.guests[0].phone,
            "999"
        )
